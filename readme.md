...
This has the same letters as [Barry Smyth](https://towardsdatascience.com/what-i-learned-from-playing-more-than-a-million-games-of-wordle-7b69a40dbfdb)'s **TALES**, which scores 3.64 in this algorithm 3.66 in its own), but with only 99.96% success (95% in it own), and remember that there are no plurals in *Wordle* solutions.
...
Through over 5 millions test plays, this *Wordle Lab* program, as part of the complete [13-point strategy](https://github.com/wolfospealain/Wordle-Lab#wordle-strategy), calculates the best start word as **SLATE**  - a strategy which is 100% successful and with an average score of 3.59 (or 3.33 using word-counting).
