...
11. When there are more possible guesses from the grey letters remaining than plays available, play a word solely to **eliminate** as many of the letter options as possible (except on the last play).
...
[Bertrand Fan](https://bert.org/2021/11/24/the-best-starting-word-in-wordle/)'s calculation for **SOARE** is very popular. For this program it scores only 3.779 with a success rate of only 99.74%.

The variation **AROSE**, recommended by [Bill Jelen](https://www.youtube.com/watch?v=gl_C7tGtD2Q), scores 3.812 with a success rate of 99.65%.
