...
if __name__ == "__main__":
    ...
    while True:
        ...
        if option == "6":
            ...
            game.run_tests(["Gek6f2.2a.1 slant"])
            game.run_tests(["Gek6f2.2a.1 cares"])
            game.run_tests(["Gek6f2.2a.1 queue"])
            game.run_tests(["Gek6f2.2a.1 adieu"])
            game.run_tests(["Gek6f2.2a.1 audio"])
            game.run_tests(["Gek6f2.2a.1 least"])
            game.run_tests(["Gek6f2.2a.1 steal"])
            game.run_tests(["Gek6f2.2a.1 stale"])
            ...
            game.run_tests(["Gek6f2.2a.1 affix"])
            game.run_tests(["Gek6f2.2a.1 aeros"])
            game = Game(Dictionary().words)
